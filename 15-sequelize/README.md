...
* [Simple Sequelize Demo](1-Class-Content/15.1/Activities/03-Chirpy-Sequelize)
* [Setting Up a Sequelize Project with the Sequelize CLI](1-Class-Content/15.1/Activities/06-SequelizeCLI)
* [Converting an ORM App to Use Sequelize](1-Class-Content/15-sequelize/15.2/07-ORM-To-Sequelize)
* [Sequelize CREATE and READ](1-Class-Content/15-sequelize/15.2/08-Sequelize-Create-Read)
* [Sequelize UPDATE and DELETE](1-Class-Content/15-sequelize/15.2/09-Sequelize-Update-Delete)
* [One-to-One, One-to-Many Associations](1-Class-Content/15-sequelize/15.3/13-Post-Author-Association)
* [Join Associated Models with Sequelize Queries](1-Class-Content/15-sequelize/15.3/14-Post-Author-Joins)

### Class Videos
[Saturday 15.1](https://codingbootcamp.hosted.panopto.com/Panopto/Pages/Viewer.aspx?id=46a9f226-dcbd-42bc-9b10-a99401213a50)
