...
var Show = require('./showCreate')
// console.log(Show)
// var createShow = new Show();
var mediaSearch = new TV();
...
inquirer.prompt([
    {
      ...
      if(userInput.type === 'TV Series'){
          ...
          inquirer.prompt([
            ...
            mediaSearch.findShow(show.search)
        })
          ...
          inquirer.prompt([
            ...
            // run the api call for TV series
            mediaSearch.findActor(celeb.search)
        })
      }else{
        inquirer.prompt([
            {   
            ...
            {   
                name: "genre",
                message: "Which genre would you categorize your show with?",
                validate: function(input){
                    if(input === ''){
                        console.log("\n Invalid input. Please enter a valid search term");
                        return false;
            ...
            var createShow = new Show(data.name, data.genre, data.budget, data.summary);
            createShow.printInfo();
        })
    }
  });