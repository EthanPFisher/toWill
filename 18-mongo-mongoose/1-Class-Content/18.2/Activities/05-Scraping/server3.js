...
axios.get("http://www.awwwards.com/websites/clean/").then(function(response) {
  ...
  $("figure.rollover").each(function(i, element) {
    ...
    */
   // sample link https://assets.awwwards.com/awards/media/cache/thumb_417_299/submissions/2018/11/5bfc16f1d19e6.png 1x, https://assets.awwwards.com/awards/media/cache/optimize/submissions/2018/11/5bfc16f1d19e6.png 2x
    var imgLink = $(element).find("a").find("img").attr("data-srcset").split(",")[0].split(" ")[0];
    // var link = $(element).children('a').children('div').children('img').attr('data-srcset').split(",")[0].split(" ")[0];
